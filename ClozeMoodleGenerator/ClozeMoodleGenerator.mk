...
LinkOptions            :=  -mwindows $(shell wx-config --libs std,aui,stc,webview,adv,ribbon) -static -limm32
...
WXCFG:=gcc_lib\mswu
Objects0=../build-$(ConfigurationName)/ClozeMoodleGenerator/main.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/ArtMetro.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/XMLParser.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/HTMLPreview.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/ExportClose.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/wxcrafter.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/MainFrame.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/win_resources.rc$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/wxcrafter_bitmaps.cpp$(ObjectSuffix) 
...
../build-$(ConfigurationName)/ClozeMoodleGenerator/ArtMetro.cpp$(ObjectSuffix): ArtMetro.cpp ../build-$(ConfigurationName)/ClozeMoodleGenerator/ArtMetro.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Pichau/Documents/GitHub/ClozeMoodleGenerator/ClozeMoodleGenerator/ArtMetro.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ArtMetro.cpp$(ObjectSuffix) $(IncludePath)
../build-$(ConfigurationName)/ClozeMoodleGenerator/ArtMetro.cpp$(DependSuffix): ArtMetro.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT../build-$(ConfigurationName)/ClozeMoodleGenerator/ArtMetro.cpp$(ObjectSuffix) -MF../build-$(ConfigurationName)/ClozeMoodleGenerator/ArtMetro.cpp$(DependSuffix) -MM ArtMetro.cpp

../build-$(ConfigurationName)/ClozeMoodleGenerator/ArtMetro.cpp$(PreprocessSuffix): ArtMetro.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) ../build-$(ConfigurationName)/ClozeMoodleGenerator/ArtMetro.cpp$(PreprocessSuffix) ArtMetro.cpp
