...
IncludePath            :=  $(IncludeSwitch). $(IncludeSwitch). $(IncludeSwitch)C:\Users\Pichau\AppData\Local\Programs\Python\Python39-32\include 
IncludePCH             := 
RcIncludePath          := 
Libs                   := $(LibrarySwitch)python39 
ArLibs                 :=  "python39" 
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch)C:\Users\Pichau\AppData\Local\Programs\Python\Python39-32\libs 
...
WXCFG:=gcc_lib\mswu
Objects0=../build-$(ConfigurationName)/ClozeMoodleGenerator/ExportClose.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/XMLParser.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/wxcrafter.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/wxcrafter_bitmaps.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/main.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/MainFrame.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/HTMLPreview.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/ClozeMoodleGenerator/win_resources.rc$(ObjectSuffix) 
